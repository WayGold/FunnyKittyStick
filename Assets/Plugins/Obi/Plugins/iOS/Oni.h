...
namespace Oni
{
    ...
    extern "C"
    {
        // used to wrap shared_prts and pass them to the outside world.
        struct ColliderGroupHandle {
            std::shared_ptr<ColliderGroup> ptr;
            ColliderGroupHandle(ColliderGroup* group):ptr(std::shared_ptr<ColliderGroup>(group)){}
            std::shared_ptr<ColliderGroup> operator->() const{
                return ptr;
            }
        };
		...
		EXPORT ColliderGroupHandle* CreateColliderGroup();
		EXPORT void DestroyColliderGroup(ColliderGroupHandle* group);
        
		EXPORT void SetColliders(ColliderGroupHandle* group, const ColliderAdaptor* colliders, int num, int dest_offset);
        EXPORT int RemoveColliders(ColliderGroupHandle* group, int num, int source_offset);
        EXPORT int GetColliderCount(ColliderGroupHandle* group);
        
		EXPORT void SetRigidbodies(ColliderGroupHandle* group, const RigidbodyAdaptor* rigidbodies, int num, int dest_offset);
        EXPORT int GetRigidbodyVelocityDeltas(ColliderGroupHandle* group, RigidbodyVelocityDelta* velocities, int num, int dest_offset);
        EXPORT int RemoveRigidbodies(ColliderGroupHandle* group, int num, int source_offset);
        EXPORT int GetRigidbodyCount(ColliderGroupHandle* group);
        
        EXPORT int GetShapeCount(ColliderGroupHandle* group,ShapeType shape);
        
		EXPORT void SetSphereShapes(ColliderGroupHandle* group, const SphereShape* shapes, int num, int dest_offset);
        EXPORT int RemoveSphereShapes(ColliderGroupHandle* group, int num, int source_offset);
        
		EXPORT void SetBoxShapes(ColliderGroupHandle* group, const BoxShape* shapes, int num, int dest_offset);
        EXPORT int RemoveBoxShapes(ColliderGroupHandle* group, int num, int source_offset);
        
		EXPORT void SetCapsuleShapes(ColliderGroupHandle* group, const CapsuleShape* shapes, int num, int dest_offset);
        EXPORT int RemoveCapsuleShapes(ColliderGroupHandle* group, int num, int source_offset);
        
		EXPORT void SetHeightmapShapes(ColliderGroupHandle* group, const HeightmapShape* shapes, int num, int dest_offset);
        EXPORT int RemoveHeightmapShapes(ColliderGroupHandle* group, int num, int source_offset);
        
        EXPORT void SetTriangleMeshShapes(ColliderGroupHandle* group, const TriangleMeshShape* shapes, int num, int dest_offset);
        EXPORT int RemoveTriangleMeshShapes(ColliderGroupHandle* group, int num, int source_offset);
        EXPORT int UpdateTriangleMeshShapes(ColliderGroupHandle* group, int num, int source_offset);
        
        EXPORT void SetEdgeMeshShapes(ColliderGroupHandle* group, const EdgeMeshShape* shapes, int num, int dest_offset);
        EXPORT int RemoveEdgeMeshShapes(ColliderGroupHandle* group, int num, int source_offset);
        EXPORT int UpdateEdgeMeshShapes(ColliderGroupHandle* group, int num, int source_offset);
		...
		EXPORT void SetColliderGroup(Solver* solver, ColliderGroupHandle* group);
